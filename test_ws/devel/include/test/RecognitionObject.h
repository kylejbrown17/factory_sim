// Generated by gencpp from file test/RecognitionObject.msg
// DO NOT EDIT!


#ifndef TEST_MESSAGE_RECOGNITIONOBJECT_H
#define TEST_MESSAGE_RECOGNITIONOBJECT_H
...
struct RecognitionObject_
{
  ...
  typedef boost::shared_ptr< ::test::RecognitionObject_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::test::RecognitionObject_<ContainerAllocator> const> ConstPtr;

}; // struct RecognitionObject_

typedef ::test::RecognitionObject_<std::allocator<void> > RecognitionObject;

typedef boost::shared_ptr< ::test::RecognitionObject > RecognitionObjectPtr;
typedef boost::shared_ptr< ::test::RecognitionObject const> RecognitionObjectConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::test::RecognitionObject_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::test::RecognitionObject_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::test::RecognitionObject_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::test::RecognitionObject_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::test::RecognitionObject_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::test::RecognitionObject_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::test::RecognitionObject_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::test::RecognitionObject_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::test::RecognitionObject_<ContainerAllocator> >
{
  ...
  static const char* value(const ::test::RecognitionObject_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x642183f1eab2edbfULL;
  static const uint64_t static_value2 = 0xa9c2ae808be707c2ULL;
};

template<class ContainerAllocator>
struct DataType< ::test::RecognitionObject_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::test::RecognitionObject_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::test::RecognitionObject_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::test::RecognitionObject_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::test::RecognitionObject_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // TEST_MESSAGE_RECOGNITIONOBJECT_H
