...
(defsystem "test-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "MsgToBot" :depends-on ("_package_MsgToBot"))
    (:file "_package_MsgToBot" :depends-on ("_package"))
    (:file "MsgToCentre" :depends-on ("_package_MsgToCentre"))
    (:file "_package_MsgToCentre" :depends-on ("_package"))
