...
(cl:defmethod cl:initialize-instance :after ((m <node_get_field-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_get_field-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<node_get_field-request> is deprecated: use test-srv:node_get_field-request instead.")))
...
(cl:defmethod fieldName-val ((m <node_get_field-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-srv:fieldName-val is deprecated.  Use test-srv:fieldName instead.")
  (fieldName m))

(cl:ensure-generic-function 'proto-val :lambda-list '(m))
(cl:defmethod proto-val ((m <node_get_field-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-srv:proto-val is deprecated.  Use test-srv:proto instead.")
  (proto m))
...
(cl:defmethod cl:initialize-instance :after ((m <node_get_field-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_get_field-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<node_get_field-response> is deprecated: use test-srv:node_get_field-response instead.")))
