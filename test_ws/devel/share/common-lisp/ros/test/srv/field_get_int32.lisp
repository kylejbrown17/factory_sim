...
(cl:defmethod cl:initialize-instance :after ((m <field_get_int32-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_get_int32-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<field_get_int32-request> is deprecated: use test-srv:field_get_int32-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <field_get_int32-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_get_int32-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<field_get_int32-response> is deprecated: use test-srv:field_get_int32-response instead.")))
