...
(cl:defmethod cl:initialize-instance :after ((m <camera_get_info-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'camera_get_info-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<camera_get_info-request> is deprecated: use test-srv:camera_get_info-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <camera_get_info-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'camera_get_info-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<camera_get_info-response> is deprecated: use test-srv:camera_get_info-response instead.")))
...
(cl:defmethod nearRange-val ((m <camera_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-srv:nearRange-val is deprecated.  Use test-srv:nearRange instead.")
  (nearRange m))
