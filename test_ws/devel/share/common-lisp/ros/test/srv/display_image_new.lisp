...
(cl:defmethod cl:initialize-instance :after ((m <display_image_new-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'display_image_new-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<display_image_new-request> is deprecated: use test-srv:display_image_new-request instead.")))
...
(cl:defmethod format-val ((m <display_image_new-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-srv:format-val is deprecated.  Use test-srv:format instead.")
  (format m))
...
(cl:defmethod cl:initialize-instance :after ((m <display_image_new-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'display_image_new-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<display_image_new-response> is deprecated: use test-srv:display_image_new-response instead.")))

(cl:ensure-generic-function 'ir-val :lambda-list '(m))
(cl:defmethod ir-val ((m <display_image_new-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-srv:ir-val is deprecated.  Use test-srv:ir instead.")
  (ir m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<display_image_new-response>)))
  ...
  "test/display_image_newResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'display_image_new-response)))
  "Returns string type for a service object of type 'display_image_new-response"
  "test/display_image_newResponse")
