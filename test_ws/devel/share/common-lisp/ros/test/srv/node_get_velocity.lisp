...
(cl:defmethod cl:initialize-instance :after ((m <node_get_velocity-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_get_velocity-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<node_get_velocity-request> is deprecated: use test-srv:node_get_velocity-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <node_get_velocity-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_get_velocity-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<node_get_velocity-response> is deprecated: use test-srv:node_get_velocity-response instead.")))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <node_get_velocity-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-srv:velocity-val is deprecated.  Use test-srv:velocity instead.")
  (velocity m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<node_get_velocity-response>)))
  ...
  "test/node_get_velocityResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'node_get_velocity-response)))
  "Returns string type for a service object of type 'node_get_velocity-response"
  "test/node_get_velocityResponse")
