...
(cl:defmethod cl:initialize-instance :after ((m <speaker_speak-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'speaker_speak-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<speaker_speak-request> is deprecated: use test-srv:speaker_speak-request instead.")))

(cl:ensure-generic-function 'text-val :lambda-list '(m))
(cl:defmethod text-val ((m <speaker_speak-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-srv:text-val is deprecated.  Use test-srv:text instead.")
  (text m))
...
(cl:defmethod cl:initialize-instance :after ((m <speaker_speak-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'speaker_speak-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<speaker_speak-response> is deprecated: use test-srv:speaker_speak-response instead.")))
