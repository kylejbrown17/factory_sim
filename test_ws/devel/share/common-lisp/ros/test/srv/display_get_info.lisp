...
(cl:defmethod cl:initialize-instance :after ((m <display_get_info-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'display_get_info-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<display_get_info-request> is deprecated: use test-srv:display_get_info-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <display_get_info-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'display_get_info-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<display_get_info-response> is deprecated: use test-srv:display_get_info-response instead.")))
