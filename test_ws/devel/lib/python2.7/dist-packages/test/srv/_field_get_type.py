...
"""autogenerated by genpy from test/field_get_typeRequest.msg. Do not edit."""
import sys
...
class field_get_typeRequest(genpy.Message):
  ...
  _type = "test/field_get_typeRequest"
...
def _get_struct_Q():
    ...
    return _struct_Q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/field_get_typeResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class field_get_typeResponse(genpy.Message):
  ...
  _type = "test/field_get_typeResponse"
  _has_header = False #flag to mark the presence of a Header object
