...
"""autogenerated by genpy from test/node_get_orientationRequest.msg. Do not edit."""
import sys
...
class node_get_orientationRequest(genpy.Message):
  ...
  _type = "test/node_get_orientationRequest"
...
def _get_struct_Q():
    ...
    return _struct_Q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/node_get_orientationResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class node_get_orientationResponse(genpy.Message):
  ...
  _type = "test/node_get_orientationResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class node_get_orientation(object):
  _type          = 'test/node_get_orientation'
