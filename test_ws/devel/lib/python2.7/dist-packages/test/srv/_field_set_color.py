...
"""autogenerated by genpy from test/field_set_colorRequest.msg. Do not edit."""
import sys
...
class field_set_colorRequest(genpy.Message):
  ...
  _type = "test/field_set_colorRequest"
...
def _get_struct_Qi4f():
    ...
    return _struct_Qi4f
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/field_set_colorResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class field_set_colorResponse(genpy.Message):
  ...
  _type = "test/field_set_colorResponse"
  _has_header = False #flag to mark the presence of a Header object
