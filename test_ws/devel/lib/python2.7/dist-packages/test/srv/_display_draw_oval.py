...
"""autogenerated by genpy from test/display_draw_ovalRequest.msg. Do not edit."""
import sys
...
class display_draw_ovalRequest(genpy.Message):
  ...
  _type = "test/display_draw_ovalRequest"
...
def _get_struct_4i():
    ...
    return _struct_4i
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/display_draw_ovalResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class display_draw_ovalResponse(genpy.Message):
  ...
  _type = "test/display_draw_ovalResponse"
  _has_header = False #flag to mark the presence of a Header object
