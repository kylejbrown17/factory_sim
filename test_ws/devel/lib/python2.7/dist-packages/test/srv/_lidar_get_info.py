...
"""autogenerated by genpy from test/lidar_get_infoRequest.msg. Do not edit."""
import sys
...
class lidar_get_infoRequest(genpy.Message):
  ...
  _type = "test/lidar_get_infoRequest"
...
def _get_struct_B():
    ...
    return _struct_B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/lidar_get_infoResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class lidar_get_infoResponse(genpy.Message):
  ...
  _type = "test/lidar_get_infoResponse"
  _has_header = False #flag to mark the presence of a Header object
