...
"""autogenerated by genpy from test/node_get_positionRequest.msg. Do not edit."""
import sys
...
class node_get_positionRequest(genpy.Message):
  ...
  _type = "test/node_get_positionRequest"
...
def _get_struct_Q():
    ...
    return _struct_Q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/node_get_positionResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class node_get_positionResponse(genpy.Message):
  ...
  _type = "test/node_get_positionResponse"
  _has_header = False #flag to mark the presence of a Header object
