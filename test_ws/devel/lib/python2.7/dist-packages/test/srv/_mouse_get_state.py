...
"""autogenerated by genpy from test/mouse_get_stateRequest.msg. Do not edit."""
import sys
...
class mouse_get_stateRequest(genpy.Message):
  ...
  _type = "test/mouse_get_stateRequest"
...
def _get_struct_B():
    ...
    return _struct_B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/mouse_get_stateResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class mouse_get_stateResponse(genpy.Message):
  ...
  _type = "test/mouse_get_stateResponse"
  _has_header = False #flag to mark the presence of a Header object
