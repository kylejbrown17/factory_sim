...
"""autogenerated by genpy from test/motor_set_control_pidRequest.msg. Do not edit."""
import sys
...
class motor_set_control_pidRequest(genpy.Message):
  ...
  _type = "test/motor_set_control_pidRequest"
...
def _get_struct_3d():
    ...
    return _struct_3d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/motor_set_control_pidResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class motor_set_control_pidResponse(genpy.Message):
  ...
  _type = "test/motor_set_control_pidResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class motor_set_control_pid(object):
  _type          = 'test/motor_set_control_pid'
