...
"""autogenerated by genpy from test/display_set_fontRequest.msg. Do not edit."""
import sys
...
class display_set_fontRequest(genpy.Message):
  ...
  _type = "test/display_set_fontRequest"
...
def _get_struct_iB():
    ...
    return _struct_iB
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/display_set_fontResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class display_set_fontResponse(genpy.Message):
  ...
  _type = "test/display_set_fontResponse"
  _has_header = False #flag to mark the presence of a Header object
