...
"""autogenerated by genpy from test/supervisor_set_labelRequest.msg. Do not edit."""
import sys
...
class supervisor_set_labelRequest(genpy.Message):
  ...
  _type = "test/supervisor_set_labelRequest"
...
def _get_struct_3did():
    ...
    return _struct_3did
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/supervisor_set_labelResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class supervisor_set_labelResponse(genpy.Message):
  ...
  _type = "test/supervisor_set_labelResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class supervisor_set_label(object):
  _type          = 'test/supervisor_set_label'
