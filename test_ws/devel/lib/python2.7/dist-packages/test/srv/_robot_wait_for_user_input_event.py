...
"""autogenerated by genpy from test/robot_wait_for_user_input_eventRequest.msg. Do not edit."""
import sys
...
class robot_wait_for_user_input_eventRequest(genpy.Message):
  ...
  _type = "test/robot_wait_for_user_input_eventRequest"
...
def _get_struct_2i():
    ...
    return _struct_2i
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/robot_wait_for_user_input_eventResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class robot_wait_for_user_input_eventResponse(genpy.Message):
  ...
  _type = "test/robot_wait_for_user_input_eventResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class robot_wait_for_user_input_event(object):
  _type          = 'test/robot_wait_for_user_input_event'
