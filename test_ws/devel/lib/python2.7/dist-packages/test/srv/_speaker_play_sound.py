...
"""autogenerated by genpy from test/speaker_play_soundRequest.msg. Do not edit."""
import sys
...
class speaker_play_soundRequest(genpy.Message):
  ...
  _type = "test/speaker_play_soundRequest"
...
def _get_struct_3db():
    ...
    return _struct_3db
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/speaker_play_soundResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class speaker_play_soundResponse(genpy.Message):
  ...
  _type = "test/speaker_play_soundResponse"
  _has_header = False #flag to mark the presence of a Header object
