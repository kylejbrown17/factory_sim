...
"""autogenerated by genpy from test/field_get_vec2fRequest.msg. Do not edit."""
import sys
...
class field_get_vec2fRequest(genpy.Message):
  ...
  _type = "test/field_get_vec2fRequest"
...
def _get_struct_Qi():
    ...
    return _struct_Qi
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/field_get_vec2fResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class field_get_vec2fResponse(genpy.Message):
  ...
  _type = "test/field_get_vec2fResponse"
  _has_header = False #flag to mark the presence of a Header object
