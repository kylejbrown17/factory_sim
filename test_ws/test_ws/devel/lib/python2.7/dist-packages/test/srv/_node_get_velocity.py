...
"""autogenerated by genpy from test/node_get_velocityRequest.msg. Do not edit."""
import sys
...
class node_get_velocityRequest(genpy.Message):
  ...
  _type = "test/node_get_velocityRequest"
...
def _get_struct_Q():
    ...
    return _struct_Q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/node_get_velocityResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class node_get_velocityResponse(genpy.Message):
  ...
  _type = "test/node_get_velocityResponse"
  _has_header = False #flag to mark the presence of a Header object
