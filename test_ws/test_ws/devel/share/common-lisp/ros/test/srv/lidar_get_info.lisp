...
(cl:defmethod cl:initialize-instance :after ((m <lidar_get_info-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lidar_get_info-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<lidar_get_info-request> is deprecated: use test-srv:lidar_get_info-request instead.")))

(cl:ensure-generic-function 'ask-val :lambda-list '(m))
(cl:defmethod ask-val ((m <lidar_get_info-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-srv:ask-val is deprecated.  Use test-srv:ask instead.")
  (ask m))
...
(cl:defmethod cl:initialize-instance :after ((m <lidar_get_info-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'lidar_get_info-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<lidar_get_info-response> is deprecated: use test-srv:lidar_get_info-response instead.")))
...
(cl:defmethod horizontalResolution-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-srv:horizontalResolution-val is deprecated.  Use test-srv:horizontalResolution instead.")
...
(cl:defmethod numberOfLayers-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-srv:numberOfLayers-val is deprecated.  Use test-srv:numberOfLayers instead.")
  (numberOfLayers m))

(cl:ensure-generic-function 'fov-val :lambda-list '(m))
(cl:defmethod fov-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-srv:fov-val is deprecated.  Use test-srv:fov instead.")
  (fov m))

(cl:ensure-generic-function 'verticalFov-val :lambda-list '(m))
(cl:defmethod verticalFov-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-srv:verticalFov-val is deprecated.  Use test-srv:verticalFov instead.")
  (verticalFov m))

(cl:ensure-generic-function 'minRange-val :lambda-list '(m))
(cl:defmethod minRange-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-srv:minRange-val is deprecated.  Use test-srv:minRange instead.")
  (minRange m))

(cl:ensure-generic-function 'maxRange-val :lambda-list '(m))
(cl:defmethod maxRange-val ((m <lidar_get_info-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-srv:maxRange-val is deprecated.  Use test-srv:maxRange instead.")
  (maxRange m))
