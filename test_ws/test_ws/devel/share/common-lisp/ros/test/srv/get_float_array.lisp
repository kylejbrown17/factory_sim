...
(cl:defmethod cl:initialize-instance :after ((m <get_float_array-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_float_array-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<get_float_array-request> is deprecated: use test-srv:get_float_array-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <get_float_array-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'get_float_array-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<get_float_array-response> is deprecated: use test-srv:get_float_array-response instead.")))
