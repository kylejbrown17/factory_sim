...
(cl:defmethod cl:initialize-instance :after ((m <field_set_color-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_set_color-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<field_set_color-request> is deprecated: use test-srv:field_set_color-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <field_set_color-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_set_color-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<field_set_color-response> is deprecated: use test-srv:field_set_color-response instead.")))
