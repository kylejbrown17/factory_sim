...
"""autogenerated by genpy from test/supervisor_movie_start_recordingRequest.msg. Do not edit."""
import sys
...
class supervisor_movie_start_recordingRequest(genpy.Message):
  ...
  _type = "test/supervisor_movie_start_recordingRequest"
...
def _get_struct_5iB():
    ...
    return _struct_5iB
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/supervisor_movie_start_recordingResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class supervisor_movie_start_recordingResponse(genpy.Message):
  ...
  _type = "test/supervisor_movie_start_recordingResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class supervisor_movie_start_recording(object):
  _type          = 'test/supervisor_movie_start_recording'
