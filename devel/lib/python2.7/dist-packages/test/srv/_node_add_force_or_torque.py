...
"""autogenerated by genpy from test/node_add_force_or_torqueRequest.msg. Do not edit."""
import sys
...
class node_add_force_or_torqueRequest(genpy.Message):
  ...
  _type = "test/node_add_force_or_torqueRequest"
...
def _get_struct_Q3dB():
    ...
    return _struct_Q3dB
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/node_add_force_or_torqueResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class node_add_force_or_torqueResponse(genpy.Message):
  ...
  _type = "test/node_add_force_or_torqueResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class node_add_force_or_torque(object):
  _type          = 'test/node_add_force_or_torque'
