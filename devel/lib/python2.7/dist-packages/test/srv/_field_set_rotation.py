...
"""autogenerated by genpy from test/field_set_rotationRequest.msg. Do not edit."""
import sys
...
class field_set_rotationRequest(genpy.Message):
  ...
  _type = "test/field_set_rotationRequest"
...
def _get_struct_Qi4d():
    ...
    return _struct_Qi4d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/field_set_rotationResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class field_set_rotationResponse(genpy.Message):
  ...
  _type = "test/field_set_rotationResponse"
  _has_header = False #flag to mark the presence of a Header object
