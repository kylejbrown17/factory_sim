...
"""autogenerated by genpy from test/display_image_pasteRequest.msg. Do not edit."""
import sys
...
class display_image_pasteRequest(genpy.Message):
  ...
  _type = "test/display_image_pasteRequest"
...
def _get_struct_Q2iB():
    ...
    return _struct_Q2iB
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/display_image_pasteResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class display_image_pasteResponse(genpy.Message):
  ...
  _type = "test/display_image_pasteResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class display_image_paste(object):
  _type          = 'test/display_image_paste'
