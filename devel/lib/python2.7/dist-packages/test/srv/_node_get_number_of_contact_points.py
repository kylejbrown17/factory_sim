...
"""autogenerated by genpy from test/node_get_number_of_contact_pointsRequest.msg. Do not edit."""
import sys
...
class node_get_number_of_contact_pointsRequest(genpy.Message):
  ...
  _type = "test/node_get_number_of_contact_pointsRequest"
...
def _get_struct_Q():
    ...
    return _struct_Q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/node_get_number_of_contact_pointsResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class node_get_number_of_contact_pointsResponse(genpy.Message):
  ...
  _type = "test/node_get_number_of_contact_pointsResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class node_get_number_of_contact_points(object):
  _type          = 'test/node_get_number_of_contact_points'
