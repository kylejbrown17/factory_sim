...
"""autogenerated by genpy from test/field_get_vec3fRequest.msg. Do not edit."""
import sys
...
class field_get_vec3fRequest(genpy.Message):
  ...
  _type = "test/field_get_vec3fRequest"
...
def _get_struct_Qi():
    ...
    return _struct_Qi
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/field_get_vec3fResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class field_get_vec3fResponse(genpy.Message):
  ...
  _type = "test/field_get_vec3fResponse"
  _has_header = False #flag to mark the presence of a Header object
