...
"""autogenerated by genpy from test/lidar_get_layer_point_cloudRequest.msg. Do not edit."""
import sys
...
class lidar_get_layer_point_cloudRequest(genpy.Message):
  ...
  _type = "test/lidar_get_layer_point_cloudRequest"
...
def _get_struct_i():
    ...
    return _struct_i
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from test/lidar_get_layer_point_cloudResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class lidar_get_layer_point_cloudResponse(genpy.Message):
  ...
  _type = "test/lidar_get_layer_point_cloudResponse"
  _has_header = False #flag to mark the presence of a Header object
...
class lidar_get_layer_point_cloud(object):
  _type          = 'test/lidar_get_layer_point_cloud'
