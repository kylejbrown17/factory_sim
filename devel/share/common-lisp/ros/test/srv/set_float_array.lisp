...
(cl:defmethod cl:initialize-instance :after ((m <set_float_array-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_float_array-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<set_float_array-request> is deprecated: use test-srv:set_float_array-request instead.")))

(cl:ensure-generic-function 'values-val :lambda-list '(m))
(cl:defmethod values-val ((m <set_float_array-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-srv:values-val is deprecated.  Use test-srv:values instead.")
  (values m))
...
(cl:defmethod cl:initialize-instance :after ((m <set_float_array-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'set_float_array-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<set_float_array-response> is deprecated: use test-srv:set_float_array-response instead.")))
