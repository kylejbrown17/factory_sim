...
(cl:defmethod cl:initialize-instance :after ((m <display_set_font-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'display_set_font-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<display_set_font-request> is deprecated: use test-srv:display_set_font-request instead.")))
...
(cl:defmethod antiAliasing-val ((m <display_set_font-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-srv:antiAliasing-val is deprecated.  Use test-srv:antiAliasing instead.")
  (antiAliasing m))
...
(cl:defmethod cl:initialize-instance :after ((m <display_set_font-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'display_set_font-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<display_set_font-response> is deprecated: use test-srv:display_set_font-response instead.")))
