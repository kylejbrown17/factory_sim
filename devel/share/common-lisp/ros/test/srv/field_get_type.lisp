...
(cl:defmethod cl:initialize-instance :after ((m <field_get_type-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_get_type-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<field_get_type-request> is deprecated: use test-srv:field_get_type-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <field_get_type-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_get_type-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<field_get_type-response> is deprecated: use test-srv:field_get_type-response instead.")))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <field_get_type-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-srv:type-val is deprecated.  Use test-srv:type instead.")
  (type m))
