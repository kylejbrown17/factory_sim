...
(cl:defmethod cl:initialize-instance :after ((m <robot_set_mode-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_set_mode-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<robot_set_mode-request> is deprecated: use test-srv:robot_set_mode-request instead.")))

(cl:ensure-generic-function 'arg-val :lambda-list '(m))
(cl:defmethod arg-val ((m <robot_set_mode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-srv:arg-val is deprecated.  Use test-srv:arg instead.")
  (arg m))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <robot_set_mode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test-srv:mode-val is deprecated.  Use test-srv:mode instead.")
  (mode m))
...
(cl:defmethod cl:initialize-instance :after ((m <robot_set_mode-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'robot_set_mode-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<robot_set_mode-response> is deprecated: use test-srv:robot_set_mode-response instead.")))
