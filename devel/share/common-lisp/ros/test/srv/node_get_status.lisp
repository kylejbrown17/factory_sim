...
(cl:defmethod cl:initialize-instance :after ((m <node_get_status-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_get_status-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<node_get_status-request> is deprecated: use test-srv:node_get_status-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <node_get_status-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'node_get_status-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<node_get_status-response> is deprecated: use test-srv:node_get_status-response instead.")))
