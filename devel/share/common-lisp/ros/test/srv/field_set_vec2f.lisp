...
(cl:defmethod cl:initialize-instance :after ((m <field_set_vec2f-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_set_vec2f-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<field_set_vec2f-request> is deprecated: use test-srv:field_set_vec2f-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <field_set_vec2f-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'field_set_vec2f-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test-srv:<field_set_vec2f-response> is deprecated: use test-srv:field_set_vec2f-response instead.")))
